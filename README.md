...
L’obiettivo è rendere la gestione del router più veloce, comoda e accessibile rispetto al pannello web originale.
...
## 🧩 Contribuire
Sono benvenuti:
- test su altri router Huawei  
- segnalazioni bug  
- suggerimenti per nuove funzionalità  
- pull request  

Apri una issue o una PR per contribuire.

---

## ☕ Supporta il progetto
La funzione di supporto sarà disponibile **direttamente nell’estensione** in una futura versione.
